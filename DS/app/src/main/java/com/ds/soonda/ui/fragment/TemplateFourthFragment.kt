...
import com.ds.soonda.databinding.FragmentTemplateFourthBinding
import com.ds.soonda.model.AcroMediaFileType
import com.ds.soonda.util.Utils


class TemplateFourthFragment(vararg adFilePath: String) : Fragment() {

    private val adFilePath: Array<String> = adFilePath as Array<String>

    private lateinit var binder: FragmentTemplateFourthBinding
    ...
    override fun onCreateView(
        ...
        binder = FragmentTemplateFourthBinding.inflate(inflater)
        return binder.root
    }
